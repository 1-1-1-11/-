...
npm run orderwise:configure -- --source-kind cli --auto-adb --adb "C:\Users\你\AppData\Local\Microsoft\WinGet\Packages\Google.PlatformTools_Microsoft.Winget.Source_8wekyb3d8bbwe\platform-tools\adb.exe" --source-apps "美团" --orderwise-model-url "http://localhost:4244/v1" --orderwise-model-name "autoglm-phone-9b" --phone-agent-api-key-env PHONE_AGENT_API_KEY --enable-source
```
